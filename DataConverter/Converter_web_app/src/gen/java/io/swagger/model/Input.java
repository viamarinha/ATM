 ...
 * Input
 */
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2021-03-06T02:30:02.840Z[GMT]")public class Input   {
  @JsonProperty("type")
   ...
   **/
  @JsonProperty("customerData")
  @Schema(example = "<book><id>102</id> <title>swagger</title><author>smartBear</author></book>", description = "")
